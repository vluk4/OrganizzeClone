...
class ReceitasActivity : AppCompatActivity() {
    ...
    private var receitaAtualizada: Double = 0.00
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editDataR.setText(DateCustom.dataAtual())
    ...
    fun salvarReceita(view: View) {
        ...
        if (validarCamposReceita()){
            ...
            val valorRecuperado = editValorR.text.toString().toDouble()

            movimentacao = Movimentacao().apply {
                valor = valorRecuperado
                categoria = editCategoriaR.text.toString()
                descricao = editDescricaoR.text.toString()
                data = editDataR.text.toString()
                tipo = "r"
            }
    ...
    fun validarCamposReceita(): Boolean {
        ...
        val textoValor = editValorR.text.toString()
        val textoData = editDataR.text.toString()
        val textoDescricao = editDescricaoR.text.toString()
        val textoCategoria = editCategoriaR.text.toString()
