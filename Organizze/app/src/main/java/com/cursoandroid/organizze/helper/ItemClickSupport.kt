...
class ItemClickSupport private constructor(private val recyclerView: RecyclerView) {
    ...
    init {
        ...
        // replacing the com.cursoandroid.listadetarefas.helper.ItemClickSupport without removing
    ...
    companion object {
        fun addTo(view: RecyclerView): ItemClickSupport {
            // if there's already an com.cursoandroid.listadetarefas.helper.ItemClickSupport attached
...
// Extension function
fun RecyclerView.addItemClickSupport(configuration: ItemClickSupport.() -> Unit = {}) = ItemClickSupport.addTo(
    this
).apply(configuration)
